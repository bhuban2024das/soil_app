...
class PaymentPage extends StatefulWidget {
  ...
  final Future<void> Function(int, BuildContext) placeOrder;
...
class _PaymentPageState extends State<PaymentPage> {
  ...
  void _onPaymentSuccess(String orderId) async {
    ...
    await widget.placeOrder(widget.paymentId, context);
    setState(() {
  ...
  Future<void> _initiatePayment() async {
    ...
    final session = CFSessionBuilder()
        ...
        .setPaymentSessionId(widget.sessionId)
        .build();
...
//   void _updateOrderStatus(String orderId, String status, String paymentId) async {
//     SharedPreferences prefs = await SharedPreferences.getInstance();
//     final String token = prefs.getString('userToken') ?? '';
...
//     final Uri updateUrl = Uri.parse("${Constants.apiBaseUrl}/payments/${widget.paymentId}/status");
...
//     _updateOrderStatus(orderId, "COMPLETED", widget.paymentId.toString());
...
//   void _onPaymentError(CFErrorResponse error, String orderId) {
//     _updateOrderStatus(orderId, "FAILED", widget.paymentId.toString());
//     setState(() {
//       message = "Payment failed: ${error.getMessage()}";
//       isProcessing = false;
//     });
