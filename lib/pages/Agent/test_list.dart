...
class SoilTestInputForm extends StatelessWidget {
  const SoilTestInputForm({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Soil Test Input Form'),
      ),
      body: Center(
        child: Text('Soil Test Input Form Content'),
      ),
    );
  }
}
