...
class DSIMapWidget extends StatefulWidget {
  const DSIMapWidget({Key? key, this.topChild, this.bottomChild, this.onTap})
      : super(key: key);
  final Widget? topChild, bottomChild;
  final Function? onTap;

  @override
  _DSIMapWidgetState createState() => _DSIMapWidgetState();
}

class _DSIMapWidgetState extends State<DSIMapWidget> {
